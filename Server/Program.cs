...
//Swaggerê›íË
app.MapMagicOnionHttpGateway("_",app.Services.GetService<MagicOnion.Server.MagicOnionServiceDefinition>().
...
options.Info.title = "EquipmentAPI";
options.Info.description = "ëïîıïiÇÃAPIÅB";
